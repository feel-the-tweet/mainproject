...
<!-- Favicons y miniaturas para Movil -->
        ...
        <title>Extracted hashtags - FeeltheTweet</title>
</head>
<body>
<!-- Uses a header that scrolls with the text, rather than staying
        ...
        <!-- Title -->
        <span class="mdl-layout-title">Extracted hashtags</span>
        ...
        <h3></h3>
            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--12-col centered-w">
   				<h4>We found these hashtags</h4>
								<ul class="demo-list-item mdl-list centered-c">
									<c:forEach items="${requestScope.trends}" var="trend">
										<li class="mdl-list__item"><span
											class="mdl-list__item-primary-content"><i class="material-icons">label</i><c:out value="${trend}" />
										</span></li>
									</c:forEach>
								</ul>
                </div>
