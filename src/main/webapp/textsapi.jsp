...
<body>
  ...
  <tbody>
	...
	<c:forEach items="${requestScope.textos}" var="text">
		<tr>
		<td class="mdl-data-table__cell--non-numeric"><c:out value="${text.id}"/></td>
		<td class="mdl-data-table__cell--non-numeric"><c:out value="${text.title}"/></td>
		<td class="mdl-data-table__cell--non-numeric"><c:out value="${text.content}"/></td>
		<td class="mdl-data-table__cell--non-numeric"><c:out value="${text.sentiment}"/><p></td>
		</tr>
	</c:forEach>
