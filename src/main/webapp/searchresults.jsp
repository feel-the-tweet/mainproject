...
<!-- Favicons y miniaturas para Movil -->
        ...
        <title>Showing tweets - FeeltheTweet</title>
</head>
<body>
<!-- Uses a header that scrolls with the text, rather than staying
  ...
  <thead>
    <tr>
      ...
      <th class="mdl-data-table__cell--non-numeric">View user</th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td class="mdl-data-table__cell--non-numeric"><button class="mdl-button"><a href="https://twitter.com/${status.user.screenName}"><i class="material-icons">account_circle</i></a></button></td>
    </tr>
    </c:forEach>
  </tbody>
</table>
