				...
				<div class="page-content">
					<div class="mdl-grid">
								...
								<ul class="demo-list-item mdl-list">
									<c:forEach items="${requestScope.trends}" var="trend">
										<li class="mdl-list__item"><span
											class="mdl-list__item-primary-content"><i class="material-icons">label</i><c:out value="${trend.name}" />
										</span></li>
									</c:forEach>
								</ul>
							</div>
						...
						<div class="mdl-cell mdl-cell--4-col">
							<div class="mycontent">
								<img src="img/FTTBirds.png" class="logo">
								<button onclick="location.href='signin';"
									class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
									<i class="material-icons">perm_identity</i> Sign in with
									Twitter
								</button>
							</div>
						</div>
						<div class="mdl-cell mdl-cell--4-col">
							<div class="mycontent">
								<a class="twitter-timeline" data-width="300" data-height="500"
									...
									href="https://twitter.com/FeelTheTweet_">Tweets by
									FeelTheTweet_</a>
							</div>
						</div>
					</div>
		...
		<div class="demo-layout-transparent mdl-layout mdl-js-layout">
			...
			<div class="mdl-layout__drawer">
				...
				<nav class="mdl-navigation">
					...
					<a class="mdl-navigation__link" href="/googleDriveListing">My
						Drive files</a> <a class="mdl-navigation__link"
						href="functionality.jsp">Functionality</a>
				</nav>
			</div>
			<main class="mdl-layout__content">
			<div class="page-content">
						...
						<div class="mdl-cell mdl-cell--4-col trends">
							<div class="mycontent">
								...
								<ul class="demo-list-item mdl-list">
									<c:forEach items="${requestScope.trends}" var="trend">
										<li class="mdl-list__item"><span
											class="mdl-list__item-primary-content trend"><i class="material-icons">label</i><c:out value="${trend.name}" />
										</span></li>
									</c:forEach>
								</ul>
							</div>
							...
							<div class="mycontent">
								<form action="/post" method="post">
									<div class="mdl-textfield mdl-js-textfield tweetsend">
										<textarea class="mdl-textfield__input" id="sample5"
											type="text" rows="3" name="text"></textarea>
										<label class="mdl-textfield__label" for="sample5">What's
											happening?</label>
									</div>
									<input type="submit" name="post" value="Send tweet"
										class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
									</input>
								</form>
							</div>
